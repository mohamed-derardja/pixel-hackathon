...
with open("scripts/output/front_paths.json", "w", encoding="utf-8") as f:
    json.dump({"male": mf, "female": ff}, f, indent=2)

print("Wrote front_paths.json")
print(f"Male zones: {len(mf)}, Female zones: {len(ff)}")
